...
const ignoreKeyword = '@pullhawk: ignore'
...
### Chat with <img src="https://avatars.githubusercontent.com/in/347564?s=41&u=fad245b8b4c7254fe63dd4dcd4d662ace122757e&v=4" alt="Image description" width="20" height="20">  pullHawk Bot (\`@pullHawk\`)
- Reply on review comments left by this bot to ask follow-up questions. A review comment is a comment on a diff or a file.
- Invite the bot into a review comment chain by tagging \`@pullHawk\` in a reply.
...
- Add \`@pullHawk: ignore\` anywhere in the PR description to pause further reviews from the bot.
