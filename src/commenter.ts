...
export const COMMENT_GREETING = `${getInput('bot_icon')}   pullHawk`

export const COMMENT_TAG =
  '<!-- This is an auto-generated comment by pullHawk -->'

export const COMMENT_REPLY_TAG =
  '<!-- This is an auto-generated reply by pullHawk -->'

export const SUMMARIZE_TAG =
  '<!-- This is an auto-generated comment: summarize by pullHawk -->'

export const IN_PROGRESS_START_TAG =
  '<!-- This is an auto-generated comment: summarize review in progress by pullHawk -->'

export const IN_PROGRESS_END_TAG =
  '<!-- end of auto-generated comment: summarize review in progress by OSS pullHawk -->'

export const DESCRIPTION_START_TAG =
  '<!-- This is an auto-generated comment: release notes by OSS pullHawk -->'
export const DESCRIPTION_END_TAG =
  '<!-- end of auto-generated comment: release notes by OSS pullHawk -->'

export const RAW_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: raw summary by OSS pullHawk -->
<!--
`
export const RAW_SUMMARY_END_TAG = `-->
<!-- end of auto-generated comment: raw summary by OSS pullHawk -->`

export const SHORT_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: short summary by OSS pullHawk -->
<!--
`

export const SHORT_SUMMARY_END_TAG = `-->
<!-- end of auto-generated comment: short summary by OSS pullHawk -->`
